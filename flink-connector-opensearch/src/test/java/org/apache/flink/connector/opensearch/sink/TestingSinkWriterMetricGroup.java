...
public class TestingSinkWriterMetricGroup extends ProxyMetricGroup<MetricGroup>
    ...
    static TestingSinkWriterMetricGroup getSinkWriterMetricGroup(MetricGroup parentMetricGroup) {
        final OperatorIOMetricGroup operatorIOMetricGroup =
                UnregisteredMetricGroups.createUnregisteredOperatorMetricGroup().getIOMetricGroup();
        return getSinkWriterMetricGroup(operatorIOMetricGroup, parentMetricGroup);
    }

    static TestingSinkWriterMetricGroup getSinkWriterMetricGroup(
            OperatorIOMetricGroup operatorIOMetricGroup, MetricGroup parentMetricGroup) {
