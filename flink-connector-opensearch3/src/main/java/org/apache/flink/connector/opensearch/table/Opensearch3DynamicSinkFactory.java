...
/** A {@link DynamicTableSinkFactory} for discovering Opensearch3DynamicSink. */
@Internal
public class Opensearch3DynamicSinkFactory implements DynamicTableSinkFactory {
    private static final String FACTORY_IDENTIFIER = "opensearch-3";
